...
def Login():
    ...
    nameL = Label(rootA, text='Username: ', font = ("Arial Bold", 16), bg = 'RoyalBlue4', fg = 'white') 
    pwordL = Label(rootA, text='Password: ', font = ("Arial Bold", 16), bg = 'RoyalBlue4', fg = 'white') 
    ...
    loginB = Button(rootA, text='     Login      ', font = ("Arial Bold", 12), bg = 'gray', fg = 'black',command=CheckLogin) 
    loginB.place(x = 113, y = 140)
 
    rmuser = Button(rootA, text='Delete User',font = ("Arial Bold", 12), bg = 'gray', fg='red', command=DelUser) 
